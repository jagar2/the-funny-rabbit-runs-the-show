...
class Question1(MCQuestion):
    def __init__(self):
        super().__init__(
            ...
            style=MCQ,
            question_number=1,
            keys=['q1-What-is-a-Program', 'q2-Program-Input', 'q3-Purpose-of-Loops', 'q4-Art-of-the-Breakdown'],
...
class Question2(TFQuestion):
    def __init__(self):
        super().__init__(
            ...
            question_number=2,
            keys=['q1-Program-recipe', 'q2-Output-keyboard', 'q3-Conditional-Execution', 'q4-Repetition', 'q5-Relevance of Programming'],
