...
class Question1(MCQuestion):
    def __init__(self):
        super().__init__(
            ...
            style=MCQ,
            question_number=1,
            keys=['q1-1-solar-panel-monitoring', 'q1-2-wind-turbine-efficiency'],
...
class Question3(TFQuestion):
    def __init__(self):
        super().__init__(
            ...
            style=TFStyle,
            question_number=3,
            keys=['q3-1-air-quality-check', 'q3-2-wind-speed-loop', 'q3-3-solar-battery-break'],
...
class Question2(SelectMany):
    def __init__(self):
        super().__init__(
            ...
            style=MultiSelect,
            question_number=2,
            keys=['q2-1-battery-charge-logic', 'q2-2-hydro-turbine-loops'],
