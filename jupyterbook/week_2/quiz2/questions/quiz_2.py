...
class Question1(MCQuestion):
    def __init__(self):
        super().__init__(
            title=f'Which of the following data structures in Python is mutable?',
            style=MCQ,
            question_number=1,
            keys=['q1-List-Immutability', 'q2-String-Operations'],
...
class Question3(TFQuestion):
    def __init__(self):
        super().__init__(
            title=f'In Python, the slice operation `my_list[1:4]` includes the element at index 4.',
            style=TrueFalse_style,
            question_number=3,
            keys=['q1-List-Slicing', 'q2-Dictionary-Keys'],
...
class Question2(SelectMany):
    def __init__(self):
        super().__init__(
            ...
            style=MultiSelect,
            question_number=2,
            keys=['q1-Dictionary-Operations', 'q2-**String Basics**'],
